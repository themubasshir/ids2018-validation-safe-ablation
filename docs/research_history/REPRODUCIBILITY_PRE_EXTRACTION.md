# Historical Reproducibility Note Before Complete Extraction

This file preserves the former top-level reproducibility note. Its notebook
availability and study-scope statements describe an earlier repository state
and are superseded by `REPRODUCE.md` and the final reproducibility audit.
